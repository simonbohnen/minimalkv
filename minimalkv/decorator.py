...
class StoreDecorator:
    ...
    def close(self):
        """Relays a close call to the next decorator or underlying store"""
        self._dstore.close()

    def __enter__(self):
        """Function for enter_exit context manager support"""
        return self
    ...
    def __exit__(
        ...
        """Calls close on underlying store or decorator.
